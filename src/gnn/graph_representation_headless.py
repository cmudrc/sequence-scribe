...
# Direct Mode: python src/gnn/graph_representation_headless.py
# CLI Mode: python src/gnn/graph_representation_headless.py --csv_path your_file.csv --proximity_threshold 0.2